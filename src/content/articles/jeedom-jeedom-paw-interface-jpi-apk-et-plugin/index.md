...
-   Saisir son numéro de téléphone, en cliquant sur l’icone stylo au bout de la ligne **{MY\_NUMBER}**.![](./JPI-7.png)
...
13.  Cliquer sur « **Mots clefs**« , puis aller dans « **Personnalisés**« , « **{MY\_NUMBER}**« .![](./JPI-SMS-3.png)
